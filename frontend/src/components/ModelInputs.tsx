...
import type { ModelSpecs } from '../types/calculator';
...
export const ModelInputs: React.FC<ModelInputsProps> = ({ modelSpecs, onModelChange }) => {
  const handleInputChange = (field: keyof ModelSpecs, value: number) => {
  ...
  const modelSizeGB = modelSpecs.parameters * 2; // FP16 approximation
    ...
    <div className="space-y-3">
      ...
      <div className="p-3 bg-green-50 rounded-md border border-green-200">
        ...
        <div className="grid grid-cols-1 gap-0.5 text-xs text-green-700">
          ...
          <div>Model size: ~{modelSizeGB.toFixed(1)} GB</div>
